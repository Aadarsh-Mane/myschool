...
class EigthClass extends StatefulWidget {
  @override
  _EigthClassState createState() => _EigthClassState();
}

class _EigthClassState extends State<EigthClass> {
  ...
  Future<void> _addData() async {
    if (_titleController.text.isNotEmpty &&
      ...
      await _firestore.collection('eight').add({
  ...
  Future<void> _updateData(String documentId) async {
    if (_titleController.text.isNotEmpty &&
      ...
      await _firestore.collection('Eight').doc(documentId).update(updatedData);
  ...
  Widget _buildDataList() {
    return Expanded(
      child: StreamBuilder<QuerySnapshot>(
        stream: _firestore.collection('Eight').snapshots(),
  ...
  Future<void> _deleteData(String documentId) async {
    await _firestore.collection('Eight').doc(documentId).delete();
  }
